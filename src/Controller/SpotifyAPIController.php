...
class SpotifyAPIController
{
    ...
    public function createTrackLists(): array
    {
        $metalMusic = [
            ...
            '76oKOs2o16kqZdVDLYvDgH',
            '5a3iwxwrtugLi5KEZXLnX1',
            '7LRMbd3LEoV5wZJvXT1Lwb',
            '2b9lp5A6CqSzwOrBfAFhof',
            '2JS1iE5A5RHvUPH5Zl9jlF',
            '6FbYLz3QcZb70mKlojSj1m',
            '2fed1yXI1clOEddfGyKyH2',
            '0xcF2mC6MktbXOT7kRiXoF',
        ...
        $popMusic = [
            ...
            '60WiEteADDUQKn62YIrlBx',
            '70uAATa6l9BHWfAMYFV28u'
        ];
        $electroMusic = [
            ...
            '2NBk0V7jF1481AqFjXkKKT',
            '5B03nSG8pLE48jh7kmasuL',
            '1dFkD1JfRMzwO6hwUsE8aS',
            '5aq8I9nVg1P9ZmcP9xH4Rz',
            '3PB2m8DG0y9j8EwMSr5MBN',
            '5iSEsR6NKjlC9SrIJkyL3k',
            '1FpK9rOAdGvalVwsAu68nd',
            '3Q2NRW22WgA8goEWFf2kL3',
            '0l2c67gYvWLmYkz8l1gbdn'
        ];
        $countryMusic = [
            ...
            '3TbHnaVih1wgrr3Xa1Cy03',
            '0VwTeYNjcl30DyQlt3GPe0',
            '2xYQTU2bbg6WVAmpY1eae4',
            '30m1G9YyiwQzFG7QvAZzHE',
            '6xatfNMI8NkY5XxRHAeiS4',
            '3giQ7393501IRNrd8iHugf',
            '5KqldkCunQ2rWxruMEtGh0',
            '7k1Xm1wy00hCKJDYJL5p1n',
            '2yrIW9McK27EKnerxlZpVx'
        ];
